...
interface OrderCartItemProps {
  cartItem: ICartItem;
  onDelete: (cartItem: ICartItem) => void;
  onSelect: (cartItem: ICartItem) => void;
}

const OrderCartItem: React.FC<OrderCartItemProps> = ({
  cartItem,
  onDelete,
  onSelect,
}) => {
    ...
    <>
      <div className="order-cart-item">
        <div>
          ...
          />
          <label htmlFor={cartItem.id.toString()} className="checkbox"></label>
          <img
          ...
          <div className="order-cart-item-info">
            ...
            {cartItem.product.discount !== null ? (
              <div className="price-discount">
                <p>
                  {formatPriceWithSpaces(cartItem.product.price)}
                  <span>₴</span>
                </p>
                <p>
